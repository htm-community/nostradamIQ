...
providers['CartoDB_DarkMatter'] = {
    ...
    layer: L.tileLayer('//{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}.png', {
...
providers['CartoDB_Positron'] = {
    ...
    layer: L.tileLayer('//{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="//www.openstreetmap.org/copyright">OpenStreetMap</a> &copy; <a href="//cartodb.com/attributions">CartoDB</a>',
        subdomains: 'abcd',
        maxZoom: 19
    })
...
providers['OpenStreetMap_BlackAndWhite'] = {
    ...
    layer: L.tileLayer('//{s}.tiles.wmflabs.org/bw-mapnik/{z}/{x}/{y}.png', {
        maxZoom: 18,
        attribution: '&copy; <a href="//www.openstreetmap.org/copyright">OpenStreetMap</a>'
    })
};
...
providers['OpenStreetMap_DE'] = {
    ...
    layer: L.tileLayer('//{s}.tile.openstreetmap.de/tiles/osmde/{z}/{x}/{y}.png', {
        maxZoom: 18,
        attribution: '&copy; <a href="//www.openstreetmap.org/copyright">OpenStreetMap</a>'
    })
}
...
providers['Esri_WorldTerrain'] = {
    ...
    layer: L.tileLayer('//server.arcgisonline.com/ArcGIS/rest/services/World_Terrain_Base/MapServer/tile/{z}/{y}/{x}', {
...
providers['Esri_OceanBasemap'] = {
    ...
    layer: L.tileLayer('//server.arcgisonline.com/ArcGIS/rest/services/Ocean_Basemap/MapServer/tile/{z}/{y}/{x}', {
...
providers['HERE_normalDay'] = {
    ...
    layer: L.tileLayer('//{s}.{base}.maps.cit.api.here.com/maptile/2.1/maptile/{mapID}/normal.day/{z}/{x}/{y}/256/png8?app_id={app_id}&app_code={app_code}', {
...
providers['HERE_normalDayGrey'] = {
    ...
    layer: L.tileLayer('//{s}.{base}.maps.cit.api.here.com/maptile/2.1/maptile/{mapID}/normal.day.grey/{z}/{x}/{y}/256/png8?app_id={app_id}&app_code={app_code}', {
        attribution: 'Map &copy; 1987-2014 <a href="//developer.here.com">HERE</a>',
        subdomains: '1234',
        mapID: 'newest',
        app_id: 'Y8m9dK2brESDPGJPdrvs',
...
providers['HERE_satelliteDay'] = {
    ...
    layer: L.tileLayer('//{s}.{base}.maps.cit.api.here.com/maptile/2.1/maptile/{mapID}/satellite.day/{z}/{x}/{y}/256/png8?app_id={app_id}&app_code={app_code}', {
        attribution: 'Map &copy; 1987-2014 <a href="//developer.here.com">HERE</a>',
        subdomains: '1234',
        mapID: 'newest',
        app_id: 'Y8m9dK2brESDPGJPdrvs',
